<?php
    ...
    class HelperController extends Controller {
        ...
        public function getBuktiFaktur(Request $request) {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-report/filter-bukti-faktur',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ],
        ...
        public function getTglStok(Request $request) {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-report/filter-tanggal-stok',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ],
        ...
        public function getVendor(Request $request) {
            ...
            'query' => [
                'kode_vendor' => $request->query('kode_vendor')
            ]
            ]);
        ...
        public function getRak(Request $request) {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-report/filter-rak',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ],
        ...
        public function getPeriodeSopH() {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-report/filter-periode-soph',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ]
        ...
        public function getBuktiSopH(Request $request) {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-report/filter-bukti-soph',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ],
        ...
        public function getFilterPeriodeReturPmb2() {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-report/filter-periode-retur-pmb2',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ]
        ...
        public function getFilterBuktiReturPmb2(Request $request) {
            $client = new Client();
            $response = $client->request('GET',  config('api.url').'esaku-report/filter-bukti-retur-pmb2',[
            'headers' => [
                'Authorization' => 'Bearer '.Session::get('token'),
                'Accept'     => 'application/json',
            ],
