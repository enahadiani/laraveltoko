<script type="text/javascript">
    function drawLap(formData){
        saiPostLoad('esaku-report/lap-stock-opname-hold', null, formData, null, function(res){
        ...
        if(data.length > 0){
            ...
            <div class='table-responsive'>
                <table class="borderless mb-2 table-header" style="width:100%;" >
                    ...
                    <tr>
                        <td colspan="3" >LAPORAN STOCK OPNAME HOLD</td>
                        <td colspan="12" class="vtop">&nbsp;</td>
                        <td class="vtop text-right">&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2" style='width:100px'>NO SOPH</td>
                        <td colspan="" style='width:400px;text-transform:uppercase'>:&nbsp;`+data.no_soph+`</td>
                        <td colspan="12" class="vtop">&nbsp;</td>
                        <td class="vtop text-right">&nbsp;</td>
                    <tr>
                ...
                <table width='100%' class='table table-bordered table-striped'>
                    ...
                    <tr>
                        ...
                        <th width='80' class='header_laporan text-center' style='text-transform:uppercase'>Selisih</th>
                    </tr>
                    </thead>
                    <tbody>`;
                        var total=0; 
                        ...
                        for (var x=0;x<res.res.data_detail.length;x++)
                        {
                            ...
                            if(data.no_hold == line2.no_hold){
                                ...
                                <td  class='isi_laporan text-right'>`+number_format(parseFloat(line2.sls))+`</td>
                                </tr>`;	
                                no++;
                            }
