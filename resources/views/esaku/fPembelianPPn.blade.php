                            ...
                            <div class="col-12">
                                <table class="table" style="margin-bottom: 5px">
                                    <tr>
                                        ...
                                        <th style='padding: 3px;width:30%' colspan='2'>
                                        ...
                                        <th style='padding: 3px;width:15%' colspan='2'>
                                            <button class="btn btn-info float-right" type="button" id="btnHitungUlang">Hitung Ulang</button>
                                        </th>
                                    </tr>
                                </table>
                                <div class="col-12 grid-table" style="overflow-y: scroll; margin:0px; padding-bottom;10px">
                                    <table class="table table-striped table-bordered table-condensed gridexample" id="input-grid2">
                                        <tr>
                                            ...
                                            <th style='width:7.5%'>Subtotal Hitung</th>
                                            <th style='width:5%'></th>
                                        </tr>
                                    </table>
                                </div>
                                <div class="col-12 mt-2 float-right">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-1" hidden>
                                            <div class="form-group row">
                                                <label for="judul" class="col-2 col-form-clearPoslabel" >Biaya Tambahan</label>
                                                <div class="col-2">
                                        ...
                                        <div class="col-7">
                                            <div class="form-group row">
                                                <label for="judul" class="col-2 col-form-label" >Total</label>
                                                <div class="col-4">
                                                    <input type='text' name="total_trans" class='form-control currency' id='totrans' required readonly>
                                                </div>
            ...
            <div class='modal-content'>
                <form id='form-edit-barang'>
                    ...
                    <div class='modal-body'>
                        ...
                        <div class='form-group row'>
                            <label for="judul" class="col-3 col-form-label">Subtotal Hitung</label>
                            <div class="col-9">
                                <input type='text' class='form-control currency ' maxlength='100' id='modal-edit-subbhit' readonly>
                            </div>
                        </div>
                    </div>
                    <div class='modal-footer'>
...
<script type="text/javascript">
    ...
    function getNota(no_bukti) {
        $.ajax({
            type:'GET',
            url:"{{url('esaku-trans/pembelian3-ppn-data-nota')}}",
            dataType: 'json',
    ...
    function getBarang() {
        $.ajax({
            type:'GET',
            url:"{{url('esaku-trans/pembelian3-ppn-barang')}}",
            dataType: 'json',
            async: false,
            data:{  
                tanggal : $('#tanggal').val(),
    ...
    function hitungUlang() {
        ...
        $('.row-barang').each(function(){
            ...
            var subbhit =  subb * (100/111);
            var hrg = subbhit/removeFormat(qtyb);

            $(this).closest('tr').find('.inp-subbhit').val(number_format(subbhit));
    ...
    function hitungTotal(){
        ...
        $('.row-barang').each(function(){
            ...
            var subb = removeFormat($(this).closest('tr').find('.inp-subb').val());
            var subbhit = removeFormat($(this).closest('tr').find('.inp-subbhit').val());
            ...
            total_brg += +subb;
            total_brg_hit += +subbhit;
            // total_brg -= +total_diskon;
            
        });
        $('#totrans').val(number_format(total_brg_hit));

        var total = total_brg;
        var total_ppn = total-total_brg_hit;
    ...
    function ubahBarang(rowindex){
        ...
        var sub_hit = $("#input-grid2 tr:eq("+rowindex+")").find('.inp-subbhit').val();
        ...
        $('#modal-edit-subbhit').val(sub_hit);
    ...
    function addBarangSelect(id=null){
        ...
        if(kd1 == ''){
            ...
            $('.row-barang').each(function(){
                ...
                var subbhit_temp = $(this).closest('tr').find('.inp-subbhit').val();
                if(kd_temp == kd){
                    qty+=+(removeFormat(qty_temp));
                    // disc+=+(removeFormat(disc_temp));
                    sub+=+(removeFormat(subb_temp));
                    subhit+=+(removeFormat(subbhit_temp));
            ...
            input += "<td style='text-align:right' hidden><input type='text' name='disc_barang[]' class='change-validation inp-disc form-control '  value='"+disc+"'  required></td>";
            input += "<td style='text-align:right'><input type='text' name='subhit_barang[]' class='change-validation inp-subbhit form-control '  value='"+toRp(subhit)+"'  required readonly></td>";
    ...
    function addBarangBarcode(){
        ...
        if(kd1 == '' ){
            ...
            input += "<td style='text-align:right'><input type='text' name='satuan_barang[]' class='change-validation inp-satuanb form-control'  value='"+setSatuan(kd)+"' readonly required><input type='hidden' name='kode_akun[]' class='change-validation inp-satuanb'  value='"+setAkun(kd)+"' readonly></td>";
            input += "<td style='text-align:right'><input type='text' name='qty_barang[]' class='change-validation inp-qtyb form-control currency'  value='"+qty+"' required></td>";
            input += "<td style='text-align:right' hidden><input type='text' name='disc_barang[]' class='change-validation inp-disc form-control currency'  value='"+disc+"' readonly required></td>";
            ...
            input += "<td style='text-align:right'><input type='text' name='subhit_barang[]' class='change-validation inp-subbhit form-control currency'  value='"+toRp(subhit)+"' required></td>";
    ...
    $('#input-grid2').on('change', '.inp-subb', function(e){
    ...
    $('#edit-submit').click(function(e){
        ...
        var subhit = removeFormat($('#modal-edit-subbhit').val());
        var hrg= sub/qty;
        ...
        input += "<td style='text-align:right' hidden><input type='text' name='disc_barang[]' class='change-validation inp-disc form-control currency'  value='"+disc+"' readonly required></td>";
        input += "<td style='text-align:right'><input type='text' name='sub_barang[]' class='change-validation inp-subb form-control currency'  value='"+sub+"'  required></td>";
        input += "<td style='text-align:right'><input type='text' name='subhit_barang[]' class='change-validation inp-subbhit form-control currency'  value='"+toRp(subhit)+"'  required readonly></td>";
        input += "<td class='text-center'></a><a class='btn btn-sm ubah-barang' style='padding:0;font-size:18px !important'><i class='simple-icon-pencil'></i></a>&nbsp;<a class='btn btn-sm hapus-item ml-2' style='padding:0;font-size:18px !important'><i class='simple-icon-trash'></i><input type='hidden' name='flag_ppn[]' value='"+flag_ppn+"'></td>";
    ...
    $('#web-form-pos').submit(function(e){
        ...
        if(totrans <= 0){
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('esaku-trans/pembelian3-ppn')}}",
                dataType: 'json',
                data: formData,
                // async:false,
                contentType: false,
    ...
    $('#cetakBtn').click(function(){
        ...
        window.open("{{ url('esaku-trans/pembelian3-ppn-nota') }}/?no_bukti="+no_bukti); 
    });
