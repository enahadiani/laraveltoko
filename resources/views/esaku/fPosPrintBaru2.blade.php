...
#select-barang .selectize-control{
...
.barang-selectize-dropdown {
    position: fixed !important;
    z-index: 9999;
}
#select-barang .selectize-input .item, #select-barang .selectize-input .nama {
                            ...
                            <div class="col-12">
                                <table class="table" style="margin-bottom: 5px">
                                    <tr>
                                        ...
                                        <th style='padding: 3px;width:20%' colspan='2' id="select-barang">
...
<script type="text/javascript">
    ...
    $('#kd-barang').selectize({
        ...
        maxItems: 1,
        dropdownParent: 'body',
        dropdownClass: 'barang-selectize-dropdown selectize-dropdown',
    ...
    $('#modal-bayar2').on('click','#cetakBtn',function(e){
        ...
        $('#sai-rpt-print').click(function(){
            printPage("{{ url('esaku-report/lap-nota-pnj-print') }}/?no_bukti[]="+"="+"&no_bukti[]="+no_jual+"&no_bukti[]="+"");
        });

        $('#sai-rpt-print-prev').click(function(){
            var newWindow = window.open();
            var html = `<head>`+$('head').html()+`</head><style>`+$('style').html()+`</style><body style='background:white;'><div align="center">`+$('.preview-body .canvasPreview').html()+`</div></body>`;
        ...
        $form_parent = ".preview-body .canvasPreview";
        $formData = new FormData();
        $formData.append("no_bukti[]","=");
        $formData.append("no_bukti[]",no_jual);
        $formData.append("no_bukti[]","");
