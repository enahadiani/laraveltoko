...
<x-report-result judul="Laporan Retur Pembelian" padding="px-4 py-4"/>
...
<script type="text/javascript">
    ...
    $('#inputFilter').reportFilter({
        ...
        url :[
            "{{ url('esaku-report/filter-periode-retur-pmb2') }}",
            "{{ url('esaku-report/filter-gudang') }}",
            "{{ url('esaku-report/filter-vendor') }}",
            "{{ url('esaku-report/filter-bukti-retur-pmb2') }}"
         ],
        parameter:[
            {},
            {},
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/rptReturPembelian') }}";
    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#saku-report #canvasPreview").table2excel({
            ...
            name: "Lap_Retur_Pembelian_V2_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Lap_Retur_Pembelian_V2_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
