...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Stock Opname Harian"/>
...
<x-report-result judul="Laporan Stock Opname Harian" padding="px-4 py-4"/>
...
<script type="text/javascript">
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/rptStockOpnameHari') }}";
    ...
    $('#sai-rpt-print').click(function(){
        var no_hold = $no_bukti.from;
        printPage("{{ url('esaku-trans/nota') }}/?no_hold="+no_hold);
    });
    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#saku-report #canvasPreview").table2excel({
            ...
            name: "Lap_Stock_Opname_Harian_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Lap_Stock_Opname_Harian_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
