...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Saldo Stok"/>
...
<x-report-result judul="Laporan Saldo Stok" padding="px-4 py-4"/>
...
<script type="text/javascript">
    ...
    $('#inputFilter').reportFilter({
        kode : ['tanggal','gudang'],
        nama : ['Tangga;','Gudang'],
        header : [['Tanggal'],['Kode','Nama'],['Kode','Nama'], ['Kode','Nama']],
        headerpilih : [['Tanggal','Action'],['Kode','Nama','Action']],
        columns: [
            [
                { data: 'tanggal' },
            ],[
    ...
    $('#inputFilter').on('change','input',function(e){
        setTimeout(() => {
            $('#inputFilter').reportFilter({
                kode : ['tanggal','gudang','kelompok', 'barang'],
                nama : ['Tanggal','Gudang','Kelompok', 'Barang'],
                header : [['Tanggal'],['Kode','Nama'],['Kode','Nama'], ['Kode','Nama']],
                headerpilih : [['Tanggal','Action'],['Kode','Nama','Action'],['Kode','Nama','Action'],['Kode','Nama','Action']],
                columns: [
                    [
                        { data: 'tanggal' },
                    ],[
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/rptSaldoStok') }}";
    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#saku-report #canvasPreview").table2excel({
            ...
            name: "Lap_Saldo_Stok_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Lap_Saldo_Stok_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
