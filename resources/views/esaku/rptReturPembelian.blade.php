<script type="text/javascript">
    function drawLap(formData){
        saiPostLoad('esaku-report/lap-retur-pembelian-v2', null, formData, null, function(res){
            ...
            <div class='table-responsive'>
                <table class="borderless mb-2 table-header" style="width:100%;" >
                    <tr>
                        ...
                        <td colspan="4" class="vtop" style='width:1320px'>&nbsp;</td>
                        <td class="vmiddle text-center" style='width:120px'></td>
                    </tr>
                    <tr>
                        <td colspan="3" >LAPORAN RETUR PEMBELIAN</td>
                        <td colspan="4" class="vtop">&nbsp;</td>
                        <td class="vtop text-right">&nbsp;</td>
                    </tr>
                    <tr>
                        <td colspan="2" style='width:200px'>NO RETUR</td>
                        <td colspan="1" style='width:400px;text-transform:uppercase'>:&nbsp;`+data.no_retur+`</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style='width:400px;text-transform:uppercase'>:&nbsp;`+data.kode_vendor+` `+data.nama_vendor+`</td>
                        <td class="vtop">&nbsp;</td>
                        <td class="vtop">&nbsp;</td>
                        <td class="vtop">&nbsp;</td>
                        <td class="vtop">&nbsp;</td>
                ...
                <table width='100%' class='table table-bordered table-striped'>
                    ...
                    <tr>
                        ...
                        <th width='80' class='header_laporan text-center' style='text-transform:uppercase'>Total Qty</th>
                        <th width='80' class='header_laporan text-center' style='text-transform:uppercase'>Qty Retur</th>
                        <th width='80' class='header_laporan text-center' style='text-transform:uppercase'>Nilai Ref Beli</th>
                        <th width='80' class='header_laporan text-center' style='text-transform:uppercase'>Total Retur</th>
                    </tr>
                    </thead>
                    <tbody>`;
                        var total=0; 
                        ...
                        for (var x=0;x<res.res.data_detail.length;x++)
                        {
                            ...
                            if(data.no_retur == line2.no_bukti){
                                det+=`<tr>
                                ...
                                <td  class='isi_laporan text-right'>`+number_format(parseFloat(line2.total_qty))+`</td>
                                <td  class='isi_laporan text-right'>`+number_format(parseFloat(line2.qty_retur))+`</td>
                                <td  class='isi_laporan text-right'>`+number_format(parseFloat(line2.nilai_ref_beli))+`</td>
                                <td  class='isi_laporan text-right'>`+number_format(parseFloat(line2.total_retur))+`</td>
                                </tr>`;	
                                no++;
                            }
                ...
                <table width='100%' class='table table-bordered table-striped'>
                    ...
                    <tbody>`;
                        ...
                        for (var x=0;x<res.res.data_jurnal.length;x++)
                        {
                            ...
                            if(data.no_retur == line3.no_bukti){
