...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Stock Opname Hold"/>
...
<x-report-result judul="Laporan Stock Opname Hold" padding="px-4 py-4"/>
...
<script type="text/javascript">
    ...
    $('#inputFilter').reportFilter({
        ...
        url :[
            "{{ url('esaku-report/filter-periode-soph') }}",
            "{{ url('esaku-report/filter-gudang') }}",
            "{{ url('esaku-report/filter-bukti-soph') }}"
         ],
        parameter:[
            {},
            {},
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/rptStockOpnameHold') }}";
    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#saku-report #canvasPreview").table2excel({
            ...
            name: "Lap_Stock_Opname_Hold_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Lap_Stock_Opname_Hold_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
