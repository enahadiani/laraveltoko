...
<div class="row" id="saku-filter">
    <div class="col-12">
        <div class="card" >
            <x-report-header judul="Laporan Rekap Pembelian"/>
                            ...
                            <div class="px-4 pb-4 pt-2">
                                <form id="form-filter">
                                    ...
                                    <div id="inputFilter">
                                        ...
                                        <x-inp-filter kode="kode_vendor" nama="Vendor" selected="1" :option="array('1','3')"/>
                                        <!-- END COMPONENT -->
                                    </div>
...
<script type="text/javascript">
    ...
    $('#inputFilter').reportFilter({
        kode : ['periode','tanggal','kode_vendor'],
        nama : ['Periode','Tanggal','vendor'],
        header : [
            ['Periode'],
            ['Tanggal'],
            ['Kode','Nama'],
    ...
    $('#form-filter').submit(function(e){
        ...
        xurl = "{{ url('esaku-auth/form/rptRekapBeli') }}";
    ...
    $("#sai-rpt-excel").click(function(e) {
        ...
        $("#saku-report #canvasPreview").table2excel({
            ...
            name: "Lap_Rekap_Beli_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}",
            filename: "Lap_Rekap_Beli_{{ Session::get('userLog').'_'.Session::get('lokasi').'_'.date('dmy').'_'.date('Hi') }}.xls", // do include extension
