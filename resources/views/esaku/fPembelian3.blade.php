...
<script type="text/javascript">
    ...
    function addBarangSelect(id=null){
        ...
        if(kd1 == ''){
            ...
            input += "<td style='text-align:right'><input type='text' name='disc_barang[]' class='change-validation inp-disc form-control '  value='"+disc+"'  required></td>";
            ...
            $('.inp-subb,.inp-disc,.inp-hrgjual,.inp-saldo,.inp-hrgseb,.inp-hrgb').inputmask("numeric", {
                radixPoint: ",",
                groupSeparator: ".",
                digits: 2,
                autoGroup: true,
    ...
    function addBarangBarcode(){
        ...
        if(kd1 == '' ){
            ...
            $('.inp-subb,.inp-disc,.inp-hrgjual').inputmask("numeric", {
                radixPoint: ",",
                groupSeparator: ".",
                digits: 2,
                autoGroup: true,
