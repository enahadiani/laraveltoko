<script type="text/javascript">
    function drawLap(formData){
        saiPostLoad("{{ url('esaku-report/lap-stock-opname') }}", null, formData, null, function(res){
   ...
   function drawRptPage(data,res,from,to){
            ...
            for(var i=0;i<data.length;i++) {
                ...
                <div class="card card-body" style="margin-bottom: 50px;">
                    <table class="borderless mb-2 table-header" style="width:100%;" >
                        ...
                        <tr>
                            <td colspan="3" >LAPORAN FORMAT STOCK OPNAME</td>
                        ...
                        <tr>
                            <td colspan="2" style='width:100px'>RAK</td>
                            <td colspan="" style='width:400px;text-transform:uppercase'>:&nbsp;`+row.kode_rak+`</td>
                            <td colspan="12" class="vtop">&nbsp;</td>
                            <td class="vtop text-right">&nbsp;</td>
                        </tr>
                        <tr>
                    ...
                    <div class='table-responsive'>
                        <table width='100%' class='table table-bordered table-striped'>
                            ...
                            <tr>
                                ...
                                <th width='80' class='header_laporan text-center' style='text-transform:uppercase'>Barcode</th>
                                ...
                                <th width='80' class='header_laporan text-center' style='text-transform:uppercase'>Stok Real</th>
                            </tr>
                            </thead>
                            <tbody>`;
                                ...
                                for (var x=0;x<dataRes.data_detail.length;x++)
                                {
                                    ...
                                    if(row.kode_rak == row2.kode_rak) {
                                        // tot_harga+=parseFloat(row2.harga);
                                        // tot_jumlah+=parseFloat(row2.jumlah);
                                        // tot_total+=parseFloat(row2.total);
                                        det+=`<tr>
                                        <td align='center' class='isi_laporan'>`+no+`</td>
                                        <td class='isi_laporan'>&nbsp;`+row2.barcode+`</td>
                                        <td class='isi_laporan'>&nbsp;`+row2.kode_barang+`</td>
                                        <td class='isi_laporan'>`+row2.nama_barang+`</td>
                                        <td  class='isi_laporan text-right'>`+number_format(parseFloat(row2.stok))+`</td>
        ...
        $('#canvasPreview td:nth-child(6), #canvasPreview  th:nth-child(6)').hide();
